...
valid_tests[7]="what's the weather in Los Angeles?";
valid_tests[8]="what's the weather in Paris, France?";
valid_tests[9]="what's the weather in Paris, United States?";
valid_tests[10]="what's the weather in California?";
valid_tests[11]="what's the weather in Miami?";
valid_tests[12]="what's the weather in Algeria?";
# valid_tests[??]="what's the weather in Miami, Florida?"; Why is it parsed "Miami Florida" by the NLU??
# valid_tests[??]="what's the weather in Random City?";
